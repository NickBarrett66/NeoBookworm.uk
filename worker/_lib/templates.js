// Email template module — Worker ES module version.
// Pure logic: no env, no imports. Direct ESM conversion of api/_lib/templates.js.

const ALLOWED_VARS = new Set([
  'name', 'business', 'trade', 'trade_business',
  'portal_url', 'preview_url', 'live_url', 'current_url',
  'deliver_by', 'deliver_by_switch', 'go_live_date', 'renewal_date', 'date',
  'domain', 'suggested_domain',
  'hosting_provider', 'hosting_url', 'client_email',
  'ots_hosting', 'ots_domain', 'ots_github',
  'stripe_link', 'revisions_count', 'google_review_url',
]);
...
export { ALLOWED_VARS, TEMPLATES, SUBJECTS };
