...
| privacy.html | Complete | Footer highlights Privacy on this page. Header/nav CSS and link rules match `terms.html` (same `.site-nav` block, global `a` after hero, logo img rules before `@media`). |
