...
| Onboarding email template module | Done | Session 2, 25 May 2026. `api/_lib/templates.js` exports `ALLOWED_VARS`, `TEMPLATES`, `SUBJECTS`, `renderTemplate(id, vars)`. J1-E1 verbatim; 7 stubs for sessions that send them (`J1-E2`, `J2-E2`, `J2-Branch-A`, `J3-E2`, `J4-E2`, `C3`, `C5`). Strict allowlist — unknown id/var/missing required all throw. 27/27 tests pass (`node api/_lib/templates.test.mjs`). Reference: `docs/onboarding-email-templates.md`. |
