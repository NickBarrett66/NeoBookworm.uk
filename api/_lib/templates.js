...
const TEMPLATES = {
  ...
  'J2-Branch-A': {
    ...
    body: [
      ...
      "- The £49.99 covers the build. We'll agree the ongoing arrangement once you've seen it and you're happy.",
  ...
  'C3': {
    ...
    body: [
      ...
      '',
      'To set things in motion, the build fee is £49.99. Pay when you\'re ready:',
      '',
      '{stripe_link}',
      '',
