...
- [ ] IDs pasted into both wrangler.toml files
- [ ] Commit the updated wrangler.toml files to Git
...
- [ ] Migrations applied successfully to both staging databases
...
- [ ] `BOOKING_WORKER_URL` set for Preview environment
- [ ] `BOOKING_WORKER_URL` set for Production environment (optional but explicit)
...
- [ ] All secrets set for staging booking Worker
- [ ] All secrets set for staging landing-enquiry Worker
...
- [ ] Both Workers deployed to staging successfully
